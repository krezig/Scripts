...
RMAN_LOG_FILE=/home/oracle/log_respaldos/backup_fra_1_$(date +%Y%m%d).log
...
backup incremental level 1 database format '/u03/fra/backup/Full1_%U' plus archivelog format '/u03/fra/backup/Arc1_%U' delete input;
}
